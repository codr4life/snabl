* rename OpImp/_imp to OpData/data
* rename OpLambda to OpImp/imp
* pass lambdas to op constructor
** remove make_lambda
** inline constructors in separate header
* convert remaining Ops to lambdas
* unroll run-loop using if(optional?)-ladder
* add stack/str eqval
* add push/pop fns
** stack/str
** add pop for iter
